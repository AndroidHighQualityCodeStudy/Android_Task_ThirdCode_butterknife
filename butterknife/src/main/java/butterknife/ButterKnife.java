...
public final class ButterKnife {
    ...
    /**
     * 创建 xxx_ViewBinding.java类对象
     *
     * @param target 对应的activity
    ...
    private static Constructor<? extends Unbinder> findBindingConstructorForClass(Class<?> cls) {
        Log.e("xiaxl: ", "---findBindingConstructorForClass---");
        ...
        try {
            // 加载对应包路径下生成的xxx_ViewBinding.java 类
